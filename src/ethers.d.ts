declare module 'ethers' {
  ...
  class Contract {
    public constructor(
      addressOrENSName: string,
      contractInterface: string | object | Interface,
      signerOrProvider: providers.Provider | Wallet
    );
  ...
  namespace providers {
    ...
    class Provider {
      ...
      getLogs(filter: any): Promise<{ topics: string[]; data: string }[]>;
    ...
    class Web3Provider extends JsonRpcProvider {
      public constructor(
        web3provider: Web3CurrentProvider,
